...
public class ConstansUtil {
    public static final String SERVER_IP = "http://54.193.120.34:8080/shiro";
    ...
    public static String SQLURL="jdbc:mysql://appading.ciokck4huq8u.us-west-1.rds.amazonaws.com:3306/appading";//appadingdb.cedzrdkywfqa.us-west-1.rds.amazonaws.com:3306/shiro
    public static String SQLUSER="appading";
    public static String SQLPASSWORD="051110101";
